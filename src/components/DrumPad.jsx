...
export const DrumPad = ({ volume, power, sound, setActualSound }) => {
    ...
    return (
        <>
            {/*   //DRUMPAD ELEMENT */}
            <button onClick={handleClick} id={sound.id} className={`rounded-xl drum-pad bg-gray-700 p-2 md:p-10 font-bold text-xl text-green-600 active:text-green-400 shadow-2xl`}>
                {sound.keyTrigger}
