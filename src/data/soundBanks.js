const SOUND_BANKS = [
  ...
  },
  {
    ...
    subtitle: 'Lush melodic percussion',
    ...
    sounds: [
      ...
      { keyCode: 68, keyTrigger: 'D', id: 'Hi-Hat', url: 'https://s3.amazonaws.com/freecodecamp/drums/Bld_H1.mp3' },
      { keyCode: 90, keyTrigger: 'Z', id: 'Punch', url: 'https://s3.amazonaws.com/freecodecamp/drums/Perc_Stingray.mp3' },
      { keyCode: 88, keyTrigger: 'X', id: 'Snap', url: 'https://s3.amazonaws.com/freecodecamp/drums/Bld_H2.mp3' },
      { keyCode: 67, keyTrigger: 'C', id: 'Clap', url: 'https://s3.amazonaws.com/freecodecamp/drums/Dsc_Oh.mp3' },
    ],
  },
];
