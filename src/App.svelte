...
<div class="min-h-screen w-full flex items-center justify-center p-3 sm:p-5 md:p-8 relative overflow-hidden bg-slate-950">
  <div
  ...
  <div class="relative z-10 flex flex-col items-center gap-3 md:gap-4 w-full max-w-4xl">
    ...
    <div
      id="drum-machine"
      class="flex flex-col md:flex-row gap-4 md:gap-6 p-4 sm:p-5 md:p-7 rounded-3xl bg-gradient-to-b from-slate-800/80 to-slate-950 border border-slate-700/80 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.7),0_0_0_1px_rgba(255,255,255,0.04)_inset] w-full"
    >
    ...
    <p class="text-[10px] sm:text-[11px] uppercase tracking-[0.3em] text-slate-500 truncate max-w-full px-2 text-center">
